              ...
              <div class="col-sm-12" style="font-size: 26px">
                ...
                <div class="row border mb-5 p-2">
                  <div class="col">
                    ...
                    <b>N° {{ numberContract ? numberContract : _______ }}</b> e
                    que a partir desta data as partes nada têm a reclamar em
                    tempo algum. O Sócio declara neste ato que está cancelando
                    seu Título, por livre e espontânea vontade, que não consta
                    nenhum debito junto a <b>ESTÂNCIA ÁGUAS DO ITIQUIRA</b>, e
                    que não quer mais pertencer ao quadro de Associados.
                  </div>
                </div>
            ...
            <div class="row mt-5" style="font-size:15px;">
              ...
              <div class="col">
                ...
                <img
                  ...
                  class="float-left"
                  style="margin-left: -55px;opacity:.2;width:400px"
                />
              </div>
            </div>
            <!-- <div class="row">
