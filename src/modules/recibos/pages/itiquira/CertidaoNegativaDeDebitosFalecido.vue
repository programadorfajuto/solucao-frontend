      ...
      <div class="card">
        <div class="card-header">
          ...
          <div class="row mt-3">
            ...
            <div class="col-md-3">
              <div class="form-group">
                <label for="numberContract">N° do Contrato</label>
                <input
                  type="text"
            ...
            <div class="row">
              <div class="col-sm-12" style="font-size: 26px">
                ...
                <p>
                  ...
                  <b>
                    (FALECIDO), CPF: {{ cpf }}, e o novo titular:
                    {{ newName ? newName : " NOME_DO_NOVO_TITULAR" }} CPF:
                    {{ newCpf }} do Contrato Nº {{ numberContract }} está
                  </b>
                  quitando o valor de R$ {{ value }}
                  (
                  <b style="text-transform: uppercase">{{
                    valueTyped ? valueTyped : "VALOR_EXTENSO"
                  }}</b
                  >), junto ao <b>ITIQUIRA PARK</b>. Referente a {{ reference }}
                </p>
              ...
              <div class="col" style="min-height:50%">
                <div class="text-center">
                  ...
                  <p style="text-align: center;">
                    <b>
                      <u>
                        SOLUÇÃO ÚTIL ASSESSORIA DE COBRANÇA
                      </u>
                    </b>
                  </p>
                  <p style="text-align: center;">
