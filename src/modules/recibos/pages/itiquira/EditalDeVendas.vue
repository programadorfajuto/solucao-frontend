              ...
              <div class="row mb-5">
                <div class="col-sm-12" style="font-size: 26px">
                  ...
                  <p>
                    ...
                    <b>{{ name }}</b
                    >, proprietário(a) do título Nº <b>{{ numberContract }}</b
                    >, neste ato a colocar seus títulos em EDITAL DE VENDAS. O
                    clube não se responsabiliza pelo valor da venda.
                  </p>
                  <h3 class="text-center font-weight-bold">
                    PREFERENCIAL DE VENDA
                  </h3>
