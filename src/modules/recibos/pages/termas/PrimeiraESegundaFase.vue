      ...
      <div class="card">
        <div class="card-header">
          ...
          <div class="row mt-3">
            ...
            <div class="col-md-3">
              <div class="form-group">
                <label for="operator">Número de dayUser</label>
        ...
        <div class="card-body">
          <div id="div-print">
            ...
            <div class="row">
              <div class="col-sm-12" style="font-size: 26px">
                ...
                <p>
                  ...
                  (
                  <b style="text-transform: uppercase">{{
                    valueTyped ? valueTyped : "VALOR_EXTENSO"
                  }}</b
                  >), junto ao
                  <b>CLUBE ESTANCIA TERMAS SOLAR</b>
                  . Referente ao Rateio de Ampliação Patrimonial (parque
                  aquático "1ª" FASE e "2ª" FASE).
                </p>

                <p>
                  <b>
                    <u>GANHA COMO BONIFICACÃO:</u>
                  </b>
                </p>
                ...
                <p class="pl-4">
                  <b>
                    ...
                    <u>
                      ...
                      DEPENDENTES DECLARADOS NO PRIMEIRO ANO.
                    </u>
                    <br />(&nbsp;&nbsp;&nbsp;&nbsp;)
                    <u
                      >{{ diarias }} DIÁRIA DE HOTEL PARA O CASAL, RESERVA
                      (61)39646482.</u
                    >
                    <br />(&nbsp;&nbsp;&nbsp;&nbsp;)
                    <u>{{ dayUser }} CONVITES DAY USER.</u>
                  </b>
                </p>
              </div>
            </div>
            ...
            <p>
              <b>Quantidade de Parcelas: {{ plots }}</b>
            </p>
            <div class="row mt-5">
              <div class="col">
