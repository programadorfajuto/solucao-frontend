...
export default {
  ...
  methods: {
    ...mapActions("usuarios", ["ActionAdicionarUsuario"]),
    async submit() {
      try {
        this.carregando = true;
        const mensagem = await this.ActionAdicionarUsuario(this.usuario);
        ...
        this.carregando = false;
        this.$toasted.error(
          err.data ? err.data.mensagem : "Não foi possível adicionar este usuário."
        );
      }
    }
  }
