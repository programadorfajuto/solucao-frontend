      ...
      <div class="card">
        <div class="card-header">
          <h4 class="card-title mb-5">
            Filtro de Sócios vinculados a este operador
          </h4>
          <div class="row">
            <div class="col-lg-3">
        ...
        <div class="card-body">
          ...
          <button
            v-on:click="desvincularOperador"
          ...
          <router-link
            class="btn btn-lg btn-info float-right mr-5"
            :to="`/usuarios/assign/${this.$route.params.id}`"
            >Vincular Novos Sócios</router-link
          >
...
export default {
  ...
  methods: {
    ...mapActions("socios", [
      "ActionDesvincularOperador",
      "ActionBuscarSociosPaginados",
    ]),
    async desvincularOperador() {
      try {
        this.carregando = true;
        this.model.id = this.$route.params.id;
        this.model.socios = this.selecionados;
        const mensagem = await this.ActionDesvincularOperador(this.model);
        ...
        this.$toasted.error(
          err.data
            ? err.data.mensagem
            : "Não foi possível desvincular estes sócios."
        );
      }
    },
